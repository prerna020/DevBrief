...
from .prompts.learning_mode_v1 import LEARNING_MODE_PROMPT_V1
...
async def review_diff(diff: str, file_path: str) -> ReviewResult:
    ...
    for attempt, delay in enumerate(RETRY_DELAYS_SECONDS, start=1):
        ...
        try:
            completion = await client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": LEARNING_MODE_PROMPT_V1},
